...
public static class GameData
{
    public static Dictionary<EnemyType, EnemyTemplate> enemyTemplates =
        ...
        {
            { EnemyType.Bandit, new EnemyTemplate() { name = "Bandit", scoreValue = 5, goldValue = 10, maxHealth = 200, speed = 6.0f, damage = 5, attackRate = 1  } },
            { EnemyType.Giant, new EnemyTemplate() { name = "Giant", scoreValue = 12, goldValue = 40, maxHealth = 650, speed = 2.0f, damage = 20, attackRate = 2  } },
