...
namespace GameSparks.Editor
{
    ...
    public class GameSparksSettingsEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (EditorSceneManager.GetActiveScene().name == testScenePath && EditorApplication.isPlaying)
            {
            ...
            if (GUILayout.Button(testButtonText))
            {
                ...
                if (EditorSceneManager.GetActiveScene().name == testScenePath && EditorApplication.isPlaying)
                {
                    ...
                    if (EditorSceneManager.GetActiveScene().name != testScenePath)
                    {
                        if (EditorSceneManager.SaveCurrentModifiedScenesIfUserWantsTo())
                        {
                            ...
                            EditorSceneManager.SaveScene(EditorSceneManager.GetActiveScene(), testScenePath, false);
